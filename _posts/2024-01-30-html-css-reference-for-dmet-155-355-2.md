...
An [`aside`](https://www.htmldog.com/references/html/tags/aside/) can be used to represent content that is **related** to the content surrounding it. Think of pull quotes or snippets of related information in an article:
...
<figure class="wp-block-image">![Gradients](https://image-control-storage.s3.amazonaws.com/2023/03/11181959/linearGradient-1.png)<figcaption class="wp-element-caption">A simple yellow-to-red linear gradient background.</figcaption></figure>To manipulate the angle of the fading, you slot in “to” and the destination you want the transition to head to. You can head to one side:
...
<figure class="wp-block-image">![Gradients](https://image-control-storage.s3.amazonaws.com/2023/03/11182001/linearGradient2-1.png)<figcaption class="wp-element-caption">A colorful gradient extravaganza.</figcaption></figure>To get gradients to work on as many browsers as possible, you will probably also want to use `-webkit-linear-gradient` to cover Safari and older versions of Chrome. **The values of these must also exclude the “to” part**, if used.
...
<figure class="wp-block-image">![Gradients](https://image-control-storage.s3.amazonaws.com/2023/03/11182004/radialGradient2-1.png)<figcaption class="wp-element-caption">A circular radial gradient.</figcaption></figure>Using “closest-side”, “closest-corner”, “farthest-side” and “farthest-corner” you can also specify if the gradient is contained by the sides or corners of the box nearest to or furthest away from the origin:
...
<figure class="wp-block-image">![Gradients](https://image-control-storage.s3.amazonaws.com/2023/03/11182008/linearGradient3-1.png)<figcaption class="wp-element-caption">Color stops in a linear gradient.</figcaption></figure>## Repeating gradients
...
<figure class="wp-block-image">![Gradients](https://image-control-storage.s3.amazonaws.com/2023/03/11182009/repeatingGradient-1.png)<figcaption class="wp-element-caption">A repeating linear gradient.</figcaption></figure>Or something a bit more solid:
...
<figure class="wp-block-image">![Gradients](https://image-control-storage.s3.amazonaws.com/2023/03/11182011/repeatingGradient2-1.png)<figcaption class="wp-element-caption">A repeating radial gradient.</figcaption></figure>## Assignment

- Create your an example of the following:
- 5 Examples of a Linear Gradient (in a div): Use 2 with two colors and 3 with multiple colors using HSL colors.
- Create two unique Radial Gradients
- Create a two circular radial gradient
- Create a gradient that includes a color stop and all the other examples shown above ie: at top left etc
- Vary the positioning of the gradient (top-right, top-left etc…)
- create a linear gradient using HSL color. Use at least 6 colors. [https://www.quackit.com/css/color/charts/hsl\_color\_chart.cfm](https://www.quackit.com/css/color/charts/hsl_color_chart.cfm)
- Unrelated best practice! Include: &lt;meta name=”viewport” content=”width=device-width, initial-scale=1.0″&gt; within the head tags in your HTML. This will help make sure that your web pages are always mobile-compliant. (We will still need other CSS to make that happen.)
